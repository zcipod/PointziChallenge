    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateAdded', models.DateField(default=datetime.date(2020, 10, 3))),
                ('reader', models.ManyToManyField(to='bookList.User')),
            ],
        ),
    ]
